...
export default function Sponsors() {
	...
	return (
		<section className="max-w-screen-md w-full mx-auto px-4 py-24 gap-12 md:px-8 flex flex-col justify-center items-center">
			...
			{/*  sm:grid-cols-6 grid-rows-3 */}
			<div className="w-full grid grid-cols-1 gap-5 place-items-center justify-center items-center">
				<Tooltip content="GSB">
					<motion.svg
						initial={{ y: 5, opacity: 0 }}
						whileInView={{
						...
						dangerouslySetInnerHTML={{ __html: gsb }}
						className="rounded-md h-20 w-16"
					>
						{/* <Image
							src="/assets/landing/gsb.jpg"
							alt="GSB"
							width={48}
							height={48}
						/> */}
